...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Diary":
			resolverName, err := entityResolverNameForDiary(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Diary": %w`, err)
			}
			switch resolverName {
			...
			case "findDiaryByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findDiaryByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindDiaryByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Diary": %w`, err)
				}
		...
		case "Music":
			resolverName, err := entityResolverNameForMusic(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Music": %w`, err)
			}
			switch resolverName {
			...
			case "findMusicByID":
				id0, err := ec.unmarshalNString2string(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findMusicByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindMusicByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Music": %w`, err)
				}
...
func entityResolverNameForDiary(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findDiaryByID", nil
	}
	return "", fmt.Errorf("%w for Diary", ErrTypeNotFound)
}

func entityResolverNameForMusic(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
		...
		return "findMusicByID", nil
	}
	return "", fmt.Errorf("%w for Music", ErrTypeNotFound)
}
